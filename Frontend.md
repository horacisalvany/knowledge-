...
- [Angular](#angular)
  ...
  - [Modules](#modules)
  - [Upgrade to a new version (steps)](#upgrade-to-a-new-version-steps)
- [Angular 16 Migration – Full Guide](#angular-16-migration--full-guide)
  - [1. Migration README (What Was Done and Why)](#1-migration-readme-what-was-done-and-why)
    - [1.1 Initial Situation](#11-initial-situation)
    - [1.2 Target Environment](#12-target-environment)
    - [1.3 Migration Strategy Used](#13-migration-strategy-used)
    - [1.4 Key Commands Used During Migration](#14-key-commands-used-during-migration)
  - [2. Post-Migration Cleanup](#2-post-migration-cleanup)
    - [2.1 Remove Unused / Legacy Files](#21-remove-unused--legacy-files)
    - [2.2 Normalize Package Manager](#22-normalize-package-manager)
    - [2.3 Verify Angular Versions](#23-verify-angular-versions)
    - [2.4 Fix Tests (Angular 16+)](#24-fix-tests-angular-16)
  - [3. Plan to Avoid Problems in Future Angular Upgrades](#3-plan-to-avoid-problems-in-future-angular-upgrades)
    - [3.1 Always Start with Node Compatibility](#31-always-start-with-node-compatibility)
    - [3.2 Use Local Angular CLI (Golden Rule)](#32-use-local-angular-cli-golden-rule)
    - [3.3 One Package Manager Only](#33-one-package-manager-only)
    - [3.4 Upgrade in Small Steps](#34-upgrade-in-small-steps)
    - [3.5 Check Third-Party Compatibility First](#35-check-third-party-compatibility-first)
    - [3.6 Treat Tests as First-Class Citizens](#36-treat-tests-as-first-class-citizens)
